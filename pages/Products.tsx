    ...
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center space-x-3 w-full md:w-auto">
           ...
           <Button className="py-2 px-4 text-xs h-[38px] bg-[#1A1A1A] text-white">
      ...
      {viewMode === 'grid' && (
         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {products.map((product) => (
               <div key={product.id} className="group bg-white rounded-2xl border border-[#E5E5E5] overflow-hidden hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  <div className="relative aspect-[3/4] bg-[#F7F7F5] overflow-hidden">
                     ...
                     <div className="absolute top-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button className="p-2 bg-white/90 backdrop-blur rounded-full shadow-sm hover:bg-black hover:text-white transition-colors">
                  ...
                  {products.map((product) => (
                     <tr key={product.id} className="group hover:bg-[#F7F7F5] transition-colors">
                        ...
                        <td className="py-4 px-6 text-right">
                           <button className="p-2 rounded hover:bg-white text-[#9CA3AF] hover:text-[#1A1A1A] transition-colors">
                              <MoreHorizontal size={16} />
                           </button>
                        </td>
                     </tr>
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-[#1A1A1A] text-white px-6 py-3 rounded-full shadow-2xl flex items-center gap-6 z-50 animate-in slide-in-from-bottom-4 duration-500">
         <span className="text-xs font-bold uppercase tracking-widest">2 Items Selected</span>
