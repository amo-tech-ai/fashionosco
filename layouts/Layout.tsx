...
export const Layout: React.FC = () => {
  ...
  return (
    <AssistantProvider>
      <div className="min-h-screen flex flex-col bg-white text-black selection:bg-black selection:text-white relative">
        {/* Editorial Header */}
             ...
             <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                   ...
                   <ul className="space-y-4 text-sm text-gray-500">
                      ...
                      <li><Link to="/architecture" className="hover:text-black font-bold text-black">Architecture</Link></li>
                   </ul>
                </div>
                <div>
                   <h4 className="text-xs font-bold uppercase tracking-widest mb-6">Platforms</h4>
                   <ul className="space-y-4 text-sm text-gray-500">
