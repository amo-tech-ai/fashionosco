    ...
    <div className={`luxury-card p-6 border-l-4 transition-all duration-700 ${statusColors[health]} backdrop-blur-xl`}>
      <div className="flex justify-between items-start mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] opacity-60 font-sans">Ops Intelligence</h3>
        ...
        <div className="text-right">
           ...
           <span className="text-[9px] font-black text-gray-400 uppercase tracking-widest font-sans">Temporal Delta</span>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
           ...
           <div className="bg-white/50 border border-gray-100 p-4 rounded-xl flex flex-col gap-1">
              <span className="text-[8px] font-black text-gray-400 uppercase tracking-widest font-sans">Atmosphere</span>
              <span className="text-sm font-mono font-bold flex items-center gap-1.5">
                 <Sun size={12} className="text-orange-400" /> 17:40 <span className="text-[10px] font-normal text-gray-400 font-sans">Golden Hour</span>
              </span>
           </div>
        </div>
      </div>
